...
Z = -.5 - al + 0         #these are shorthand variables for the exponents
X = - al + 1.93007       #in the logistic CDFs; I don't use them in the function
Y = .5 - al + 1.430073   #but I've pasted in values here to check
