...
*As an example, If we look at "112_bill_positions_destring.dta" data, there are two actions on bill number 2. There exists a large difference between the total 
* number of interests groups that took positions on these actions.
