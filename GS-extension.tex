...
\begin{itemize}
	...
	\item Substituting logistic for normal in Equation~\ref{eq:firstfoc}
		\begin{equation}
					\frac{e^{- \alpha + b(0)}}{1+e^{- \alpha + b(0)}} + \frac{e^{\frac{\beta}{2} - \alpha + b\left(\frac{1}{2}\right)}}{1+e^{\frac{\beta}{2} - \alpha + b\left(\frac{1}{2}\right) }}
					- 2\frac{e^{- \alpha + b(0)}}{1+e^{- \alpha + b(0)}}  \frac{e^{\frac{\beta}{2} - \alpha + b\left(\frac{1}{2}\right) }}{1+e^{\frac{\beta}{2} - \alpha + b\left(\frac{1}{2}\right) }} = \frac{\left(1+e^{-\frac{\beta}{2} - \alpha + b\left(-\frac{1}{2}\right)}\right)^2}{W_B \: e^{-\frac{\beta}{2} - \alpha + b\left(-\frac{1}{2}\right)} }
					\label{eq:logistic}
				\end{equation}
		\begin{itemize}
...
\begin{itemize}
	...
	\item Then Equation \ref{eq:logistic} is equivalent to:
		\begin{equation}
			\frac{e^{X}}{1+e^{X}} + \frac{e^{Y}}{1+e^{Y }} - 2\frac{e^{X}}{1+e^{X}}  \frac{e^{Y }}{1+e^{Y }} = \frac{\left(1+e^{Z}\right)^2}{W_B \: e^{Z} }
					\label{eq:logistic2}
		\end{equation}
		\[
			\frac{e^{X} + 2e^{X+Y} + e^{Y}}{\left(1+e^{X}\right)\left(1+e^{Y }\right)} - 2\frac{e^{X+Y}}{\left(1+e^{X}\right)\left(1+e^{Y }\right)} = \frac{\left(1+e^{Z}\right)^2}{W_B \: e^{Z} }
		\]
		\[
