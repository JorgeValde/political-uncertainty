...
\]
There are 8 patterns of positive and zero components in the 3-dimensional vector of bribes, $b' = (b\left(0\right),b\left(\frac{1}{2}\right), b\left(-\frac{1}{2}\right)\right)$. \\
...
\begin{itemize}
	\item Which is
		\[
		  \frac{\beta}{2} + \alpha = \alpha - b(0) - \frac{\beta}{2} + \alpha - b\left(\frac{1}{2}\right)
		\]
		\[
		  \beta = \alpha - \left(b(0) + b\left(\frac{1}{2}\right) \right)
		\]
\end{itemize}
