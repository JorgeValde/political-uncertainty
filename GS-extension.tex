	...
	\item Take a model with three legislators with ideal points at $z=-\frac{1}{2}$, $z=0$ and $z=\frac{1}{2}$. Then the three probabilities are
		\begin{itemize}
			...
			Substituting from the definition of $X$,
			  \begin{multline}
			    \max_{b\left(-\frac{1}{2}\right), b\left(0\right), b\left(\frac{1}{2}\right)} 
					\Phi\left(-\frac{\beta}{2} - \alpha + b(z) \right)\Phi\left(- \alpha + b(z) \right)\left(1-\Phi\left(\frac{\beta}{2} - \alpha + b(z) \right)\right)  + \\
					\Phi\left(-\frac{\beta}{2} - \alpha + b(z) \right)\left(1-\Phi\left(- \alpha + b(z) \right)\right)\Phi\left(\frac{\beta}{2} - \alpha + b(z) \right) + \\
					\left(1-\Phi\left(-\frac{\beta}{2} - \alpha + b(z) \right)\right)\Phi\left(- \alpha + b(z) \right)\Phi\left(\frac{\beta}{2} - \alpha + b(z) \right) + \\
					\Phi\left(-\frac{\beta}{2} - \alpha + b(z) \right)\Phi\left(- \alpha + b(z) \right)\Phi\left(\frac{\beta}{2} - \alpha + b(z) \right)
				\end{multline}
		\end{itemize}
\end{itemize}
