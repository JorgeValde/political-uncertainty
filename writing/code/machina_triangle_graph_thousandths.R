...
v = seq(0.01,WB,0.001) #this will be counter variable in loop
...
for (j in 1:length(v)) {
  ...
  b0 = seq(0,t,.001*t) #possible bribe values for legislator located at 0
  bp5 = seq(0,t,.001*t) #possible bribe values for legislator located at 0.5
...
bribe0 = (out[l,5]-1)*l/1000000      #scale column location of max value for total spent (l)
bribep5 = (out[l,4]-1)*l/1000000     #likewise scale row column for 0.5 legislator
bribenp5 = l/1000 - bribe0 -bribep5 # -0.5 legislator is calculated as residual
