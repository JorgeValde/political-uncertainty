...
\item When is endogenizing political pressure important for answering optimal design questions?
	...
	\end{itemize}
	\vskip.1in
\item Can trade agreements be used to manipulate domestic lobbying incentives?
	\begin{itemize}
...
\pause
\begin{itemize}[<+->]
	\item Standard \textit{except} weight on import-competing industry profits $\ga(s,e)$: 
		\begin{itemize}
...
\begin{frame}{Repeated Game Intuition}
\pause
...
\begin{frame}{When the world is more complicated... (2)}
\begin{itemize}[<+->]
...
\vskip.2in
\pause
Optimal $\tau^a$ may lead to government applying $\tau(\ga(s,e))$
\pause
\begin{itemize}[<+->]
