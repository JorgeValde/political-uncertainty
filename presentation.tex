...
\author[Buzard, DiTraglia and Saiegh \hspace{2.7in} \url{kbuzard@syr.edu}]{Kristy Buzard \inst{1} \and Frank DiTraglia \inst{2} \and Sebastian Saiegh \inst{3}}
\institute{\inst{1} Syracuse University and The Wallis Institute \and \inst{2} University of Pennsylvania \and \inst{3} UC San Diego}
\date{April 16, 2016}
\begin{document}
\maketitle
