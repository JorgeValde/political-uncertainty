...
\begin{itemize}
   ...
   Equation~\ref{eq:twoways} can be rearranged into two similar forms. First:
	  ...
	  \begin{equation}
		...
		\end{equation}
	\end{itemize}	
In this case where the non-negativity constraint binds for the variable associated with $Z$, that is $b\left(\frac{1}{2}\right)$, we know that $Z < 0$ (not true because we can have $\alpha < -.5$). Note that this is due to the construction of the problem. This means $e^Z < 1$. In this case,
	\begin{itemize}
